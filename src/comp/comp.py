...
print("Ends with e:")
b = [person.name for person in humans if person.name[len(person.name)-1:len(person.name)]=='e']
print(b)
...
letterSearch = 'CDEFG'
c = [person.name for person in humans if letterSearch.find(person.name[0]) != -1] #person.name[0]=='C' or person.name[0]=='G']
print(c)
